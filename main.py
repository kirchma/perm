...
path = '/Users/mkirch/OneDrive/Promotion/PERM/raw_data/HY_Z21.txt'
measurement = Measurement(path=path)
measurement.calculate_permeability([1e-20, 0.001], parameter='both')
#measurement.calculate_uncertainty([1e-18, 0.001])
